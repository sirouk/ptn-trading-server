...
class dYdXWrapper:
    ...
    order_side_map = {"LONG": ORDER_SIDE_BUY, "SHORT": ORDER_SIDE_SELL, OrderUtil.FLAT: OrderUtil.FLAT}

    formatter_map = {
        MARKET_BTC_USD: {SIZE_DECIMAL: "0.0000", PRICE_DECIMAL: "0"},
        MARKET_ETH_USD: {SIZE_DECIMAL: "0.00", PRICE_DECIMAL: "0.0"},
        MARKET_MATIC_USD: {SIZE_DECIMAL: "0", PRICE_DECIMAL: "0.0000"},
        MARKET_ADA_USD: {SIZE_DECIMAL: "0", PRICE_DECIMAL: "0.000"},
        MARKET_DOGE_USD: {SIZE_DECIMAL: "10", PRICE_DECIMAL: "0.0000"},
        MARKET_DOT_USD: {SIZE_DECIMAL: "0.0", PRICE_DECIMAL: "0.00"},
        MARKET_LTC_USD: {SIZE_DECIMAL: "0.00", PRICE_DECIMAL: "0.0"},
        MARKET_AVAX_USD: {SIZE_DECIMAL: "0.0", PRICE_DECIMAL: "0.00"},
        MARKET_LINK_USD: {SIZE_DECIMAL: "0.0", PRICE_DECIMAL: "0.000"},
        MARKET_UNI_USD: {SIZE_DECIMAL: "0.0", PRICE_DECIMAL: "0.000"},
        MARKET_XLM_USD: {SIZE_DECIMAL: "0", PRICE_DECIMAL: "0.0000"},
        MARKET_EOS_USD: {SIZE_DECIMAL: "0", PRICE_DECIMAL: "0.000"},
        MARKET_XTZ_USD: {SIZE_DECIMAL: "0", PRICE_DECIMAL: "0.000"},
        MARKET_XMR_USD: {SIZE_DECIMAL: "0.00", PRICE_DECIMAL: "0.0"},
        MARKET_SOL_USD: {SIZE_DECIMAL: "0.0", PRICE_DECIMAL: "0.000"},
    }
    ...
    def format_size(self, size, market):
        return decimal.Decimal(size).quantize(decimal.Decimal(self.formatter_map[market][self.SIZE_DECIMAL]), rounding=decimal.ROUND_DOWN)
    ...
    def create_order(self, order, market, logger, price_multiplier=float(0)):
        ...
        logger.info(f"creating order with specifications. " f"side: [{side}], " f"leverage: + [{str(leverage)}], " f"price multiplier: [{str(price_multiplier)}]")
        ...
        price = decimal.Decimal(market_price * price_multiplier).quantize(decimal.Decimal(self.formatter_map[market][self.PRICE_DECIMAL]), rounding=decimal.ROUND_DOWN)
    ...
    def get_position(self, trade_pair):
        positions = self._client.private.get_positions(market=trade_pair, status=POSITION_STATUS_OPEN).data["positions"]
        if len(positions) > 0:
            return positions[0]
        else:
            return None
